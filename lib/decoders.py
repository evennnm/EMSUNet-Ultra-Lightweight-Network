...
class decoder_EMSUnet(nn.Module):
    def __init__(self, channels=[512, 320, 128, 64], kernel_sizes=[3, 3, 5], expansion_factor=6, lgag_ks=3, activation='relu6'):
        ...
        self.emag3 = EMAG(F_g=channels[1], F_l=channels[1], F_int=channels[1] // 2, )
        ...
        self.emag2 = EMAG(F_g=channels[2], F_l=channels[2], F_int=channels[2] // 2, )
        ...
        self.emag1 = EMAG(F_g=channels[3], F_l=channels[3], F_int=int(channels[3] / 2), )
